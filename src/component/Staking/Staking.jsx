...
const Staking = ({ mode }) => {
  const color = mode ? "#00AEEF" : "#E0F7FA";
    ...
    <Container maxWidth="lg" sx={{ py: "50px" }}>
        ...
        <Grid container sx={{ mt: "10px" }} spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Stack justifyContent="end" alignItems="end">
              ...
              >
                {address ? (loading ? "Processing" : "Stak") : "Connect Wallet"}
              </LoadingButton>
            </Stack>
          </Grid>
        </Grid>
      ...
      <Paper
        sx={{
          ...
          mx: "auto",
          border: mode ? "1px solid #00AEEF" : "1px solid #E0F7FA",
          my: "40px",
        }}
        align="center"
      >
            ...
            <TableBody>
              {paginatedAndReversedData?.length > 0 ? (
                paginatedAndReversedData.map((details, index) => {
                  const [duration, amount, withdrawn, start, end] = details;

                  return (
                    <TableRow key={index}>
                      <TableCell sx={{ color: mode ? "#00AEEF" : "#ffffff" }}>
                      ...
                      {withdrwableAmount &&
                        withdrwableAmount[index] !== undefined && (
                          ...
                          >
                            &nbsp;
                            {getCommas(formatEther(withdrwableAmount[index]))}
                          </TableCell>
                        )}
                      <TableCell sx={{ color: mode ? "#00AEEF" : "#ffffff" }}>
                        <LoadingButton
                          ...
                          color="primary"
                          onClick={address ? () => withdrawTokens(index) : open}
                        >
                          {address
                    ...
                    sx={{
                      ...
                      "& .MuiTablePagination-actions": {
                        "& .MuiIconButton-root": {
                          ...
                          "&:hover": {
                            backgroundColor: mode ? "#007BBB" : "#f0f0f0", // Optional: Pagination control buttons hover background color
